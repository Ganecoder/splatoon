    ...
    if (select == 12) {
        if (easter_egg == 11) {
            ...
            blast = sprites.createProjectileFromSprite(img`
                ...
                . . . 7 . . . 7 . . . 7 . . . . 
                `, mysterious, 0, 0)
            blast.setKind(SpriteKind.blast)
            blast.follow(mySprite, 30)
        }
    }
})
forever(function () {
    ...
    if (select == 12) {
        if (easter_egg == 13) {
            ...
            blast = sprites.createProjectileFromSprite(img`
                ...
                `, mysterious, 0, 0)
            blast.setKind(SpriteKind.blast)
            tiles.placeOnTile(blast, tiles.getTileLocation(Math.round(randint(0, 9)), 0))
            blast.vy = 100
        }
    }
})
...
forever(function () {
    ...
    if (boss_health == 0) {
        game.splash("You were not supposed to get here!")
        game.splash("It is unbelievable that you beat me!")
        game.splash("Have without this game!")
        game.splash("Grrrrrrrrrrrrrraaaaaaaaaa!")
        game.over(true)
    }
})
forever(function () {
